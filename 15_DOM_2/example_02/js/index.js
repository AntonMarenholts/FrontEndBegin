...
// сортируем студентов
function sortStudentByGerman(){
  students.sort((studentA, studentB) => studentA.german.localeCompare(studentB.german));
  renderStudents(students);
...
sortBtn.addEventListener("click", sortStudentByGerman);
